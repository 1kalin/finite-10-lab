...
Submission destinations and evidence URLs must be public HTTPS URLs without embedded credentials. Localhost, `.local`, loopback, unspecified, link-local, unique-local, mapped-private, reserved, and other non-public IPv4/IPv6 literals fail closed. Rejection and report reasons are enumerated in `lib/moderation-workflow.mjs`; human-readable detail remains mandatory.
